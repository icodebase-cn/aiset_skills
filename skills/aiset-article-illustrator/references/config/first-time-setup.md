...
description: First-time setup flow for aiset-article-illustrator preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.aiset_skills/aiset-article-illustrator/EXTEND.md` | Current project |
| User | `~/.aiset_skills/aiset-article-illustrator/EXTEND.md` | All projects |
