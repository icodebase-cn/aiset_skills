...
description: EXTEND.md YAML schema for aiset-image-gen user preferences
---
...
default_provider: null      # google|openai|dashscope|aiset|null (null = auto-detect)
...
default_model:
  ...
  aiset: null              # e.g., "gemini-3-pro-image-preview"
---
```
...
| `default_model.aiset` | string\|null | null | aiset default model |
...
default_model:
  ...
  aiset: "gemini-3-pro-image-preview"
---
```
