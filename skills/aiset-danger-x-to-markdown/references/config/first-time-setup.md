...
description: First-time setup flow for aiset-danger-x-to-markdown preferences
---
...
options:
  - label: "User (Recommended)"
    description: "~/.aiset_skills/ (all projects)"
  - label: "Project"
    description: ".aiset_skills/ (this project only)"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.aiset_skills/aiset-danger-x-to-markdown/EXTEND.md` | All projects |
| Project | `.aiset_skills/aiset-danger-x-to-markdown/EXTEND.md` | Current project |
