...
name: hv-analysis
description: |
  纵横分析法（Horizontal-Vertical Analysis）深度研究Skill。融合了索绪尔的历时-共时分析、社会科学的纵向-横截面研究设计、商学院案例研究法与竞争战略分析的核心思想。
...
纵横分析法（Horizontal-Vertical Analysis）深度研究Skill。融合了索绪尔的历时-共时分析、社会科学的纵向-横截面研究设计、商学院案例研究法与竞争战略分析的核心思想。适用于系统性研究产品、公司、概念、技术或人物，最终产出排版精美的PDF研究报告。
