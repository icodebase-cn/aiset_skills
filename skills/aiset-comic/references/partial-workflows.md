...
```bash
/aiset-comic content.md --storyboard-only
```
...
```bash
/aiset-comic content.md --prompts-only
```
...
```bash
/aiset-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/aiset-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/aiset-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/aiset-comic comic/topic-slug/ --regenerate 0
```
