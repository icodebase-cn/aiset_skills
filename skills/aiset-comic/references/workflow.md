...
test -f .aiset_skills/aiset-comic/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.aiset_skills/aiset-comic/EXTEND.md" && echo "user"
```

| Path | Location |
|------|----------|
| `.aiset_skills/aiset-comic/EXTEND.md` | Project directory |
| `$HOME/.aiset_skills/aiset-comic/EXTEND.md` | User home |
...
**Strategy A: Using `--ref` parameter** (e.g., aiset-image-gen)

```bash
# Each page generation MUST include --ref
npx -y bun ${SKILL_DIR}/../aiset-image-gen/scripts/main.ts \
