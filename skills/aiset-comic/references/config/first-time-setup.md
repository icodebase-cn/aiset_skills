...
description: First-time setup flow for aiset-comic preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.aiset_skills/aiset-comic/EXTEND.md` | Current project |
| User | `~/.aiset_skills/aiset-comic/EXTEND.md` | All projects |
