...
description: First-time setup flow for aiset-post-to-wechat preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.aiset_skills/aiset-post-to-wechat/EXTEND.md` | Current project |
| User | `~/.aiset_skills/aiset-post-to-wechat/EXTEND.md` | All projects |
