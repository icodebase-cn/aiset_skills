...
Structure for user preferences in `.aiset_skills/aiset-slide-deck/EXTEND.md`.
...
Then use with: `/aiset-slide-deck content.md --style style-name`
...
1. `.aiset_skills/aiset-slide-deck/EXTEND.md` (project)
2. `$HOME/.aiset_skills/aiset-slide-deck/EXTEND.md` (user)
