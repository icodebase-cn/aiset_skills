...
```bash
/aiset-slide-deck path/to/content.md
/aiset-slide-deck path/to/content.md --style sketch-notes
/aiset-slide-deck path/to/content.md --audience executives
/aiset-slide-deck path/to/content.md --lang zh
/aiset-slide-deck path/to/content.md --slides 10
/aiset-slide-deck path/to/content.md --outline-only
/aiset-slide-deck  # Then paste content
```
...
test -f .aiset_skills/aiset-slide-deck/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.aiset_skills/aiset-slide-deck/EXTEND.md" && echo "user"
```

┌──────────────────────────────────────────────────┬───────────────────┐
│                       Path                       │     Location      │
├──────────────────────────────────────────────────┼───────────────────┤
│ .aiset_skills/aiset-slide-deck/EXTEND.md         │ Project directory │
├──────────────────────────────────────────────────┼───────────────────┤
│ $HOME/.aiset_skills/aiset-slide-deck/EXTEND.md   │ User home         │
└──────────────────────────────────────────────────┴───────────────────┘
...
```bash
/aiset-slide-deck content.md --prompts-only
```
...
```bash
/aiset-slide-deck slide-deck/topic-slug/ --images-only
```
...
```bash
# Single slide
/aiset-slide-deck slide-deck/topic-slug/ --regenerate 3

# Multiple slides
/aiset-slide-deck slide-deck/topic-slug/ --regenerate 2,5,8
```
...
2. Run: `/aiset-slide-deck <dir> --regenerate N`
