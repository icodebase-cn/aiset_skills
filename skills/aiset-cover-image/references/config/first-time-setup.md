...
description: First-time setup flow for aiset-cover-image preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.aiset_skills/aiset-cover-image/EXTEND.md` | Current project |
| User | `~/.aiset_skills/aiset-cover-image/EXTEND.md` | All projects |
