...
/aiset-cover-image article.md --quick

# Specify dimensions
/aiset-cover-image article.md --type conceptual --palette warm --rendering flat-vector

# Style presets (shorthand for palette + rendering)
/aiset-cover-image article.md --style blueprint

# With reference images
/aiset-cover-image article.md --ref style-ref.png

# Direct content input
/aiset-cover-image --palette mono --aspect 1:1 --quick
[paste content]
```
...
```bash
test -f .aiset_skills/aiset-cover-image/EXTEND.md && echo "project"
test -f "$HOME/.aiset_skills/aiset-cover-image/EXTEND.md" && echo "user"
```
