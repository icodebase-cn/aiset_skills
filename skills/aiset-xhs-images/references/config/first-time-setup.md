...
description: First-time setup flow for aiset-xhs-images preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.aiset_skills/aiset-xhs-images/EXTEND.md` | Current project |
| User | `~/.aiset_skills/aiset-xhs-images/EXTEND.md` | All projects |
